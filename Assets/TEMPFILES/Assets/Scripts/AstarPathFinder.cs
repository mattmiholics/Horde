...
// I made in static class so that it can called from any script/project
// ===============================
...
namespace PathFinding3D 
{
    public static class AstarPathFinder
    {
        ...
        //TODO I tried to combine all the pathfinding script in static class but failed. 
        //TODO so i left this script as a star path finding alogrithm static class. 
        /*
        ...
        public static Vector3[] AstarPathFinder(Grid3D grid, Vector3 _startPos, Vector3 _goalPos, ref Vector3[] path,Action<Vector3[],bool> callback)
        {
            Node startNode = grid.NodeFromWorldPoints(_startPos);
            Node goalNode = grid.NodeFromWorldPoints(_goalPos);
            ...
            while (openSet.Count > 0)
            {
                ...
                if (currentNode == goalNode)
                {
                    path = RetraceVectorPath(startNode, goalNode);
                    break;
                }
