...
Shader "Shader Graphs/Flag"
{
	Properties
	{
		...
		[ASEEnd]_NoiseStrength("NoiseStrength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_DisplacementMask = v.texcoord.xy * _DisplacementMask_ST.xy + _DisplacementMask_ST.zw;
				float mulTime49 = _TimeParameters.x * _NoiseSpeed;
				float2 appendResult53 = (float2(mulTime49 , mulTime49));
				float2 texCoord54 = v.texcoord.xy * float2( 1,0.45 ) + appendResult53;
				float gradientNoise62 = GradientNoise(texCoord54,_NoiseScale);
				gradientNoise62 = gradientNoise62*0.5 + 0.5;
				float3 appendResult55 = (float3(0.0 , 0.0 , (-_NoiseStrength + (gradientNoise62 - 0.0) * (_NoiseStrength - -_NoiseStrength) / (1.0 - 0.0))));
				...
				float3 vertexValue = ( float4( v.ase_normal , 0.0 ) * ( tex2Dlod( _DisplacementMask, float4( uv_DisplacementMask, 0, 0.0) ) * float4( appendResult55 , 0.0 ) ) ).rgb;
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack15 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength );
				unpack15.z = lerp( 1, unpack15.z, saturate(_NormalStrength) );
				...
				float3 BaseColor = ( tex2DNode10 * _BaseColor ).rgb;
				float3 Normal = unpack15;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( tex2D( _MetallicMap, uv_MetallicMap ) * _Metallic ).r;
				float Smoothness = ( tex2DNode10.a * _Smoothness );
				float Occlusion = ( 1.0 - ( ( 1.0 - tex2D( _OcclusionMap, uv_OcclusionMap ) ) * _OcclusionStrength ) ).r;
				float Alpha = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 uv_DisplacementMask = v.ase_texcoord.xy * _DisplacementMask_ST.xy + _DisplacementMask_ST.zw;
				float mulTime49 = _TimeParameters.x * _NoiseSpeed;
				float2 appendResult53 = (float2(mulTime49 , mulTime49));
				float2 texCoord54 = v.ase_texcoord.xy * float2( 1,0.45 ) + appendResult53;
				float gradientNoise62 = GradientNoise(texCoord54,_NoiseScale);
				gradientNoise62 = gradientNoise62*0.5 + 0.5;
				float3 appendResult55 = (float3(0.0 , 0.0 , (-_NoiseStrength + (gradientNoise62 - 0.0) * (_NoiseStrength - -_NoiseStrength) / (1.0 - 0.0))));
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 uv_DisplacementMask = v.texcoord0.xy * _DisplacementMask_ST.xy + _DisplacementMask_ST.zw;
				float mulTime49 = _TimeParameters.x * _NoiseSpeed;
				float2 appendResult53 = (float2(mulTime49 , mulTime49));
				float2 texCoord54 = v.texcoord0.xy * float2( 1,0.45 ) + appendResult53;
				float gradientNoise62 = GradientNoise(texCoord54,_NoiseScale);
				gradientNoise62 = gradientNoise62*0.5 + 0.5;
				float3 appendResult55 = (float3(0.0 , 0.0 , (-_NoiseStrength + (gradientNoise62 - 0.0) * (_NoiseStrength - -_NoiseStrength) / (1.0 - 0.0))));
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-17.45766,-215.2814;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-386.7968,114.9979;Inherit;False;Property;_Smoothness;Smoothness;2;0;Create;True;0;0;0;False;0;False;1;0.887;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;79.73574,-19.00608;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-391.7579,622.8882;Inherit;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;8.599743,427.6725;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-404.6785,964.2893;Inherit;False;Property;_OcclusionStrength;OcclusionStrength;6;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-361.4577,-91.28134;Inherit;False;Property;_BaseColor;BaseColor;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;198.1307,755.1644;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;41;-62.9328,756.7264;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;42;364.7203,698.4806;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-645.7289,331.4715;Inherit;False;Property;_NormalStrength;NormalStrength;8;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-442.1317,-282.7479;Inherit;True;Property;_BaseMap;BaseMap;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-422.326,215.4676;Inherit;True;Property;_NormalMap;NormalMap;7;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;21;-419.8822,419.4008;Inherit;True;Property;_MetallicMap;MetallicMap;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;25;-416.5768,738.6952;Inherit;True;Property;_OcclusionMap;OcclusionMap;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;52;-1275.279,1402.027;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;49;-1076.879,1397.028;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;50;-882.9788,1728.027;Inherit;False;Property;_NoiseScale;NoiseScale;10;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;53;-886.9323,1375.208;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;310.9175,1235.753;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;50.12318,1279.323;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DynamicAppendNode;55;-14.71616,1445.886;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;59;-506.0871,1606.263;Inherit;False;Property;_NoiseStrength;NoiseStrength;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;567.638,153.6951;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Shader Graphs/Flag;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;0;638144528888644744;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;638144534290434733;  Phong;0;638129679238003637;  Strength;0.5,False,;0;  Type;1;638144519571770305;  Tess;21.4,True,_Tessellation;638144519607363464;  Min;10,False,;0;  Max;25,False,_Tessellation;0;  Edge Length;12,True,_Tessellation;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;44;-564.36,1088.105;Inherit;True;Property;_DisplacementMask;DisplacementMask;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalVertexDataNode;57;0.5174613,1106.153;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VoronoiNode;47;-471.0789,1432.627;Inherit;False;0;0;1;4;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.NoiseGeneratorNode;62;-484.4552,1323.041;Inherit;False;Gradient;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;56;-265.6162,1447.186;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.05;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;63;-253.0691,1679.47;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;54;-724.3323,1354.408;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,0.45;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
