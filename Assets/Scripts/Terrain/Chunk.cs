...
public static class Chunk
{
    ...
    public static BlockType GetBlockFromChunkCoordinates(World worldReference, ChunkData chunkData, Vector3Int chunkCoordinates)
    {
        return GetBlockFromChunkCoordinates(worldReference, chunkData, chunkCoordinates.x, chunkCoordinates.y, chunkCoordinates.z);
    }

    public static BlockType GetBlockFromChunkCoordinates(World worldReference, ChunkData chunkData, int x, int y, int z)
    {
        ...
        return worldReference.GetBlockFromChunkCoordinates(chunkData, chunkData.worldPosition.x + x, chunkData.worldPosition.y + y, chunkData.worldPosition.z + z);
    }

    public static void SetBlock(World worldReference, ChunkData chunkData, Vector3Int localPosition, BlockType block)
    {
        ...
        {
            WorldDataHelper.SetBlock(worldReference, localPosition + chunkData.worldPosition, block);
        }
    }
    ...
    public static MeshData GetChunkMeshData(World worldReference, ChunkData chunkData)
    {
    ...
    internal static List<ChunkData> GetEdgeNeighbourChunk(World worldReference, ChunkData chunkData, Vector3Int worldPosition)
    {
        ...
        {
            neighboursToUpdate.Add(WorldDataHelper.GetChunkData(worldReference, worldPosition - Vector3Int.right));
        }
        ...
        {
            neighboursToUpdate.Add(WorldDataHelper.GetChunkData(worldReference, worldPosition - Vector3Int.up));
        }
        ...
        {
            neighboursToUpdate.Add(WorldDataHelper.GetChunkData(worldReference, worldPosition - Vector3Int.forward));
        }
